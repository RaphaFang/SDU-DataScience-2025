...
# 或是比較麻煩的 [3,-2,0,0], [-2,1,1,0], [1,-4,0,1]
# [[1, 0, 2, ,-1 | 3],
#  [0, 1, -1, 4, | -2],
#  [0, 0,  0, 0, | 0]]
...
# ------------------------------------
# solution space
# 解出來有幾個nullity就會轉換成線面空間
# 而必然包含原點，因為原點會是香量空間為零的地方，也就是 [0,0,0,0]
# 所有可能的 x,y,z 都可以在這前提達到，所以必然穿過

# ------------------------------------
# Solution Set=Particular Solution+Null Space
# Particular Solution 這就是國中時討論到

# ------------------------------------
# Rank–Nullity Theorem
# num of var = rank + nullity